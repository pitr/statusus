...
(function() {
  var Feed, Message, Nohm, RedisStore, User, app, express, http, iced, p, path, ratchet, redis, redis_client, uuid, __iced_k, __iced_k_noop;
  ...
  app.configure(function() {
    ...
    app.use(app.router);
    return app.use(ratchet.errorHandler());
  });
